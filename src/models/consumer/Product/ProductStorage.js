...
class ProductStorage {
  static getProductDetail(storeId, productId) {
    return new Promise((resolve, reject) => {
      const query = `SELECT id as productId, name as productName, imageUrl, notice, format(price,0) as price, detailImageUrl FROM Product WHERE storeId=? and id=? and status='ACTIVE';`;
